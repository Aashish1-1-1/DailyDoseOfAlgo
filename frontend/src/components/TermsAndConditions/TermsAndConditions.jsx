...
const TermsAndConditions = () => {
  return (
    <div className="min-h-screen bg-slate-900 text-white font-poppins p-6">
      ...
      <p className="mb-4">We employ the use of cookies. By accessing DailyDoseOfAlgo, you agreed to use cookies in agreement with the DailyDoseOfAlgo's Privacy Policy.</p>
      
      <h2 className="text-2xl font-bold mt-6 mb-2">License</h2>
      <p className="mb-4">Unless otherwise stated, DailyDoseOfAlgo and/or its licensors own the intellectual property rights for all material on DailyDoseOfAlgo. All intellectual property rights are reserved. You may access this from DailyDoseOfAlgo for your own personal use subjected to restrictions set in these terms and conditions.</p>
      
      <h2 className="text-2xl font-bold mt-6 mb-2">User Comments</h2>
      <p className="mb-4">Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. DailyDoseOfAlgo does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of DailyDoseOfAlgo, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions.</p>
      
      <h2 className="text-2xl font-bold mt-6 mb-2">Hyperlinking to our Content</h2>
      ...
      <h2 className="text-2xl font-bold mt-6 mb-2">Removal of links from our website</h2>
